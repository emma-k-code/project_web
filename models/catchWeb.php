<?php
    ...
    class catchWeb {
        ...
        function toCatch($db) {
            $catchData = $this->catchWeb(); // 抓取網站資料
            $this->resolveData($catchData,$db); // 解析網站資料
        }
        ...
        function resolveData($data,$db) {
            ...
            insertDatabase($db,$insertData,$invoiceDate,$invoicePs); // 寫入資料庫
        }
        
        function insertDatabase($insertData,$invoiceDate,$invoicePs) {
            // 取得資料庫設定
